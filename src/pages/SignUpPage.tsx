...
import SignUpIllustration from '../components/shared/SignUpIllustration'
...
export default function SignUpPage() {
    ...
    return (
        <div className="min-h-screen flex bg-background text-headline">
            ...
            <div className="hidden lg:flex flex-col items-center justify-center w-1/2 bg-background border-r border-secondary/10 px-12 py-16 relative overflow-hidden">
                {/* Subtle glow */}
                <div
                    className="pointer-events-none absolute inset-0"
                    style={{ background: 'radial-gradient(ellipse 70% 60% at 40% 50%, var(--color-secondary) 0%, transparent 70%)', opacity: 0.06 }}
                />
                <div className="relative z-10 flex flex-col items-center gap-8 text-center max-w-sm">
                    ...
                    <div className="space-y-2">
                        ...
                        <p className="text-sm text-paragraph leading-relaxed">
                            Join thousands of tenants and property managers who use SettleIn
                            to simplify every step of the renting process.
                        </p>
                    </div>
            ...
            <div className="flex flex-col justify-center w-full lg:w-1/2 px-6 sm:px-12 py-16">
                <div className="mx-auto w-full max-w-md">
                    ...
                    {emailSent ? (
                        <div className="rounded-sm border border-highlight/30 bg-highlight/8 p-5 text-sm">
                            <p className="font-semibold text-highlight mb-1">Almost there! Check your inbox ✉️</p>
                        ...
                        <div className="flex flex-col gap-4">
                            ...
                            <form onSubmit={handleEmailSignUp} className="flex flex-col gap-4" noValidate>
                                <div className="flex flex-col gap-1.5">
                                    <label htmlFor="signup-email" className="text-xs font-semibold text-paragraph uppercase tracking-widest">
                                        Email address
                                    </label>
                                    <input
                                        id="signup-email"
                    ...
                    <p className="mt-8 text-sm text-paragraph text-center">
                        ...
                        <Link to="/login" className="text-highlight font-semibold hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-highlight rounded-sm">
                            Sign in
                        </Link>
                    </p>
                </div>
