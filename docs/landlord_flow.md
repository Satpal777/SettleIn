...
The Landlord workflow focuses on property management, seeker evaluation, and facilitating the move-in process.
...
*   **Outcome**: After a successful visit, the landlord initiates the move-in process for the interested seeker.
...
*   **Stage 2: Lease Preparation**: Click "Draft Lease" to generate the agreement for the seeker to review.
*   **Stage 3: Signature Tracking**: Wait for the seeker to E-sign the agreement digitally.
*   **Stage 4: Finalization**: Confirm the property condition and click "Confirm & Finalize" to complete the move-in. This automatically marks the property as "Rented".
